...
Cardinal::Cardinal(const Cardinal& from)
  ...
  if (from._internal_has_integer()) {
    integer_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_integer(),
      GetArena());
  }
  ...
  if (from._internal_has_morphosyntactic_features()) {
    morphosyntactic_features_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_morphosyntactic_features(),
      GetArena());
  }
  ...
  if (from._internal_has_code_switch()) {
    code_switch_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_code_switch(),
      GetArena());
  }
...
Fraction::Fraction(const Fraction& from)
  ...
  if (from._internal_has_integer_part()) {
    integer_part_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_integer_part(),
      GetArena());
  }
  numerator_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_numerator()) {
    numerator_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_numerator(),
      GetArena());
  }
  ...
  if (from._internal_has_denominator()) {
    denominator_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_denominator(),
      GetArena());
  }
  morphosyntactic_features_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_morphosyntactic_features()) {
...
Decimal::Decimal(const Decimal& from)
  ...
  if (from._internal_has_fractional_part()) {
    fractional_part_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_fractional_part(),
      GetArena());
  }
...
Date::Date(const Date& from)
  ...
  if (from._internal_has_weekday()) {
    weekday_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_weekday(),
      GetArena());
  }
  day_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_day()) {
    day_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_day(),
      GetArena());
  }
  month_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_month()) {
    month_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_month(),
      GetArena());
  }
  ...
  if (from._internal_has_era()) {
    era_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_era(),
      GetArena());
  }
  morphosyntactic_features_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_morphosyntactic_features()) {
...
Electronic::Electronic(const Electronic& from)
  ...
  if (from._internal_has_query_string()) {
    query_string_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_query_string(),
      GetArena());
  }
  ...
  if (from._internal_has_fragment_id()) {
    fragment_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_fragment_id(),
      GetArena());
  }
  morphosyntactic_features_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_morphosyntactic_features()) {
