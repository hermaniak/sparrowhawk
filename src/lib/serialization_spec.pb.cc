...
RecordSpec::RecordSpec(const RecordSpec& from)
  ...
  if (from._internal_has_field_path()) {
    field_path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_field_path(),
      GetArena());
  }
...
ClassSpec::ClassSpec(const ClassSpec& from)
  ...
  if (from._internal_has_semiotic_class()) {
    semiotic_class_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_semiotic_class(),
      GetArena());
  }
