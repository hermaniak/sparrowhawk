...
SparrowhawkConfiguration::SparrowhawkConfiguration(const SparrowhawkConfiguration& from)
  ...
  if (from._internal_has_tokenizer_grammar()) {
    tokenizer_grammar_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_tokenizer_grammar(),
      GetArena());
  }
  ...
  if (from._internal_has_verbalizer_grammar()) {
    verbalizer_grammar_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_verbalizer_grammar(),
      GetArena());
  }
  ...
  if (from._internal_has_sentence_boundary_regexp()) {
    sentence_boundary_regexp_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_sentence_boundary_regexp(),
      GetArena());
  }
  ...
  if (from._internal_has_sentence_boundary_exceptions_file()) {
    sentence_boundary_exceptions_file_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_sentence_boundary_exceptions_file(),
      GetArena());
  }
  ...
  if (from._internal_has_serialization_spec()) {
    serialization_spec_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_serialization_spec(),
      GetArena());
  }
