...
Token::Token(const Token& from)
  ...
  if (from._internal_has_wordid()) {
    wordid_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_wordid(),
      GetArena());
  }
  spelling_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_spelling()) {
    spelling_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_spelling(),
      GetArena());
  }
  ...
  if (from._internal_has_spelling_with_stress()) {
    spelling_with_stress_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_spelling_with_stress(),
      GetArena());
  }
  ...
  if (from._internal_has_verbatim()) {
    verbatim_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_verbatim(),
      GetArena());
  }
  letters_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_letters()) {
    letters_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_letters(),
      GetArena());
  }
...
Utterance::Utterance(const Utterance& from)
  ...
  if (from._internal_has_sentence()) {
    sentence_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_sentence(),
      GetArena());
  }
  ...
  if (from._internal_has_original_sentence()) {
    original_sentence_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_original_sentence(),
      GetArena());
  }
