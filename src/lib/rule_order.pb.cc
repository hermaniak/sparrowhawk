...
Rule::Rule(const Rule& from)
  ...
  if (from._internal_has_main()) {
    main_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_main(),
      GetArena());
  }
  parens_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_parens()) {
    parens_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_parens(),
      GetArena());
  }
  ...
  if (from._internal_has_assignments()) {
    assignments_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_assignments(),
      GetArena());
  }
  redup_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_redup()) {
    redup_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_redup(),
      GetArena());
  }
...
Grammar::Grammar(const Grammar& from)
  ...
  if (from._internal_has_grammar_file()) {
    grammar_file_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_grammar_file(),
      GetArena());
  }
  ...
  if (from._internal_has_grammar_name()) {
    grammar_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_grammar_name(),
      GetArena());
  }
